...
export class FileSystemProvider
  ...
  constructor(extensionPath: string,style:string) {
...
export class FileSystemProvider2
  implements vscode.TreeDataProvider<Entry>, vscode.FileSystemProvider {
  private _onDidChangeFile: vscode.EventEmitter<vscode.FileChangeEvent[]>;
  private _extensionPath: string;
  private _style:string;
...
export class FileExplorer {
  ...
  constructor(context: vscode.ExtensionContext) {
    ...
    this.createTreeView2(context);
  }
  public createTreeView(context: vscode.ExtensionContext) {
    const treeDataProvider = new FileSystemProvider(context.extensionPath,'default');
    vscode.window.createTreeView('view-git-branch-merged', {
      treeDataProvider
    });
    
  }
  public createTreeView2(context: vscode.ExtensionContext) {
    const treeDataProvider = new FileSystemProvider2(context.extensionPath,'type2');
    vscode.window.createTreeView('view-git-branch-merged2', {
      treeDataProvider
    });
  }
}
